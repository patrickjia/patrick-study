...
public class ConstanHolder extends PropertyPlaceholderConfigurer {
	...
	public void setLocations(Resource... locations){
		...
		if( ArrayUtils.isNotEmpty(locations) && reversed ){//反转
	...
	public static void exportHeadedTo(Map<String,String> map,String keyStartWith){
		...
		if( StringUtils.isNotBlank(keyStartWith) ){
	...
	public static Integer getInteger(String key){
		String value = StringUtils.trim(CONSTS.get(key));
