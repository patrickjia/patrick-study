...
<form class="layui-form " action="">
  ...
  <div class="layui-inline">
    ...
    <div class="layui-input-inline">
      <input type="text" id="roleName" name="roleName" value="${person.roleName }" lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
    </div>
  </div>
  <div class="layui-inline">
  ...
  <div class="layui-inline">
   ...
   <div class="layui-inline">
    ...
    <div class="layui-input-inline">
      <input type="password" name="pwdConfirm" value="${person.pwd}" lay-verify="pass" placeholder="请再次输入密码" autocomplete="off" class="layui-input">
    </div>
    </div>
  </div>
  ...
  <div class="layui-inline">
    ...
    <div class="layui-input-inline">
      <input type="text" id="positionName" name="positionName"  value="${person.positionName }" lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
    </div>
  </div>
  <div class="layui-inline">
    <label class="layui-form-label">人员部门:</label>
	<div class="layui-input-inline">
		<input type="hidden"  id="deptId" name="deptId" value="${person.deptCode }">
		<input type="text"  id="deptName" class="layui-input"	name="deptName" value="${person.deptCodeName }">
	      <span class="input-group-btn">
	        <a class="btn btn-default deptSelect" href="departmentTree?type=1">选择</a>
	      </span>
	</div>
  </div>
