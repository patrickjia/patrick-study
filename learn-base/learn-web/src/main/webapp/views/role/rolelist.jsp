 ...
 <li class="layui-nav-item layui-nav-itemed">
  ...
  <li class="layui-nav-item layui-nav-itemed">
    ...
    <dl class="layui-nav-child">
      ...
      <dd ><a href="<%=basePath %>user/list">用户管理</a></dd>
      <dd class="layui-this"><a href="<%=basePath %>role/list">角色管理</a></dd>
       ...
       <div class="layui-main">
		...
		<!-- <fieldset class="layui-elem-field layui-field-title" style="margin-top: 50px;">
		 --> <!--  <legend>查询列表</legend> -->
		  ...
		  <div  >
		  	<form action="${basePath }role/list" method="get"
					id="searchForm">
		  		<table class="layui-table" lay-even="" style="height: 20px" lay-skin="nob">
		  			<tr>
		  			<td>角色编码：</td>
		  			<td><input type="text" id="roleCode" name="roleCode" value="${condition.roleCode }" class="layui-input"/></td>
		  			<td>角色名称：</td>
		  			<td><input type="text" id="roleName" name="roleName" value="${condition.roleName }" class="layui-input"/></td>
		...
		<table class="layui-table" lay-even="" lay-skin="row">
		  ...
		  <c:forEach items="${roles }" var="role">
				<tr id="tr_${role.roleId }">
					<td ><input type="checkbox" name="roleId" lay-skin="primary" value="${role.roleId }"></td>
					<td>${role.roleCode }</td>
					<td>${role.roleName  }</td>
					<td>${role.appcodeName }</td>
		  ...
		  var active = {
		    setTop: function(){
		      ...
		      layer.open({
				  ...
				  fixed: false, //不固定
				  maxmin: true,
				  content: '${basePath}role/viewrole?roleId='+chk_value
				});
