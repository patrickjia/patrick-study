...
<ul class="layui-nav layui-nav-tree site-demo-nav">
  <li class="layui-nav-item layui-nav-itemed">
    <a href="javascript:;">系统管理</a>
    <dl class="layui-nav-child">
      <dd class="layui-this"><a href="<%=basePath %>businesssystem/list">应用系统管理</a></dd>
       ...
       <div class="layui-main">
		...
		<!-- <fieldset class="layui-elem-field layui-field-title" style="margin-top: 50px;">
		 --> <!--  <legend>查询列表</legend> -->
		  ...
		  <div  >
		  	<form action="${basePath }businesssystem/list" method="get"
					id="searchForm">
		  		<table class="layui-table" lay-even="" style="height: 20px" lay-skin="nob">
		  			<tr>
		  			<td>业务系统编码：</td>
		  			<td><input type="text" id="busSysCode"	name="busSysCode" class="layui-input"/></td>
		  			<td>业务系统名称：</td>
		  			<td><input type="text" id="busSysName"	name="busSysName"class="layui-input"/></td>
		  			 <td>
		  			 <button class="layui-btn layui-btn-radius" onclick="queryData();">查询</button>
		...
		<table class="layui-table" lay-even="" lay-skin="row">
		  ...
		  <c:forEach items="${busisystems }" var="bussystem">
				<tr id="tr_${bussystem.busSysId }">
					...
					<td>${bussystem.busSysUrl}</td>
					<%-- <td>${user.positionName }</td> --%>
					<td>
						<c:if test="${bussystem.isEnabled == 0 }">
                                                                                                                                       启用
                                       </c:if>
                                       <c:if test="${bussystem.isEnabled == 1 }">
                                                                                                                                        停用
                                       </c:if>
                                      </td>
					<%-- <td>${user.appcode }</td> --%>
